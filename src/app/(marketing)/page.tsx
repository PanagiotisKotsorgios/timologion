...
export const metadata: Metadata = pageMetadata({
  ...
  absoluteTitle: true,
  description:
    "Το Τιμολόγιον είναι online πρόγραμμα ηλεκτρονικής τιμολόγησης με άμεση σύνδεση στο myDATA της ΑΑΔΕ. Έκδοσε τιμολόγια & αποδείξεις σε λιγότερο από 3 λεπτά. Δωρεάν εγγραφή — χωρίς κάρτα.",
  path: "/",
  keywords: [
    "τιμολογιο online",
...
const BULLETS = [
  ...
  "Δωρεάν εγγραφή — πληρωμή μόνο πριν την πρώτη έκδοση",
