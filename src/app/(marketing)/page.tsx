...
export const metadata: Metadata = pageMetadata({
  title: "Τιμολόγιον | Πρόγραμμα Ηλεκτρονικής Τιμολόγησης myDATA",
  absoluteTitle: true,
  description:
    "Το Τιμολόγιον είναι online πρόγραμμα ηλεκτρονικής τιμολόγησης με άμεση σύνδεση στο myDATA της ΑΑΔΕ. Έκδοσε τιμολόγια & αποδείξεις σε λιγότερο από 3 λεπτά. Δωρεάν δοκιμή — χωρίς κάρτα.",
  path: "/",
  keywords: [
    "τιμολογιο online",
    ...
    "online πρόγραμμα τιμολόγησης",
    "εφαρμογή έκδοσης παραστατικών",
    "πάροχος ηλεκτρονικής τιμολόγησης",
    "πιστοποιημένος πάροχος myDATA",
  ],
});

const BULLETS = [
  "Πρώτο τιμολόγιο σε 3 λεπτά",
  "Δωρεάν δοκιμή 14 ημερών",
  "Χωρίς κάρτα, χωρίς δέσμευση",
  "Άμεση σύνδεση με myDATA / ΑΑΔΕ",
];
      ...
      >
        <Container className="relative pt-16 pb-24 md:pt-24 md:pb-32">
          <div className="max-w-6xl">
            ...
            >
              Πιστοποιημένος πάροχος myDATA · ΑΑΔΕ
            </p>
            <h1
            ...
            >
              Το Τιμολόγιον εκδίδει τιμολόγια, αποδείξεις και όλα τα παραστατικά
              σου με άμεση σύνδεση στο myDATA της ΑΑΔΕ. Πελατολόγιο με
              αναζήτηση ΑΦΜ, POS, CRM και αναφορές σε ένα καθαρό dashboard —
              για ελεύθερους επαγγελματίες και μικρές επιχειρήσεις στην Ελλάδα.
            </p>
