    ...
    <>
      ...
      <section className="bg-white">
        ...
        >
          ...
          <Section title="5. Συνδρομές, χρεώσεις & δικαίωμα υπαναχώρησης">
            <ul className="mt-2 list-disc space-y-2 pl-5">
              <li>
                Η πλατφόρμα timologion παρέχεται δωρεάν. Η χρέωση αφορά τη
                συνδρομή του πιστοποιημένου παρόχου (Wrapp) και είναι
                ετήσια/προπληρωμένη. Οι τιμές αναγράφονται στη σελίδα{" "}
                <a
                  href="/pricing"
                  className="font-semibold text-brand-800 underline"
                >
                ...
                και στη σελίδα Συνδρομής μέσα στην εφαρμογή. Οι τιμές δεν
                συμπεριλαμβάνουν ΦΠΑ, εκτός αν αναφέρεται διαφορετικά.
              </li>
              <li>
                Κάθε ετήσια περίοδος κλείνει με ό,τι έρθει πρώτο — 12 μήνες
                ή η ολοκλήρωση του ορίου παραστατικών του πακέτου. Η
                ανανέωση δημιουργεί νέα πλήρη περίοδο με νέο 12μηνο και νέο
                όριο, χωρίς χρέωση υπέρβασης.
              </li>
              <li>
                Η τιμολόγηση της συνδρομής γίνεται απευθείας από τον πάροχο
                (Wrapp). Το timologion δεν διαχειρίζεται πληρωμές συνδρομής
                στο δικό του τραπεζικό λογαριασμό.
              </li>
              <li>
                <strong>Δικαίωμα υπαναχώρησης (καταναλωτές)</strong>: όπου
                τυγχάνει εφαρμογής η ΚΥΑ Ζ1-891/2013 και ο Ν. 2251/1994 περί
                προστασίας καταναλωτή, ο Χρήστης-καταναλωτής δικαιούται να
                υπαναχωρήσει εντός 14 ημερολογιακών ημερών από την
                ενεργοποίηση της συνδρομής, χωρίς αιτιολογία, με έγγραφη
                δήλωση στο support@timologion.gr. Το δικαίωμα χάνεται εάν η
                παροχή έχει ξεκινήσει με τη ρητή συγκατάθεσή σου και έχει
                ολοκληρωθεί εντός της περιόδου (π.χ. έχεις εκδώσει
                παραστατικά).
              </li>
              <li>
                Πέραν του παραπάνω, δεν παρέχονται επιστροφές για μη
                χρησιμοποιημένο τμήμα περιόδου, εκτός εάν το επιβάλλει ο
                νόμος.
              </li>
            </ul>
          </Section>
          ...
          <Section title="7. Πνευματικά δικαιώματα & άδεια χρήσης">
            ...
            <p className="mt-3">
              ...
              Μπορείς να τα εξάγεις οποιαδήποτε στιγμή σε μορφή CSV.
            </p>
          </Section>
