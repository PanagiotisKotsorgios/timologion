...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Απλή, διάφανη τιμολόγηση για το Τιμολόγιον. Πακέτα Basic, Standard, Business, Pro, Enterprise και Corporate με ηλεκτρονική τιμολόγηση myDATA. Από 45,96€/έτος. Ξεκίνα δωρεάν, χωρίς κάρτα.",
  path: "/pricing",
  keywords: [
    "τιμές τιμολόγηση",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Basic (45,96€/έτος) για freelancers με ~120 παραστατικά τον μήνα. Standard (142,76€/έτος) για μικρές επιχειρήσεις έως 500 παραστατικά μηνιαίως — προτεινόμενο. Business (239,56€/έτος) για ώριμες επιχειρήσεις με ομάδα και έως 1.500 παραστατικά μηνιαίως. Για μεγαλύτερους όγκους δες Pro, Enterprise, Corporate.",
  },
  {
