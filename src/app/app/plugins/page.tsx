...
const PLUGINS: Plugin[] = [
  ...
  },
  {
    ...
    icon: BarChart3,
    name: "Στατιστικά παραστατικών",
    tagline: "Τάσεις εκδόσεων, top πελάτες και είδη.",
    price: "Δωρεάν",
    perks: [
      "Ρυθμοί έκδοσης ανά μήνα",
      "Ranking πελατών & ειδών",
      "Σύγκριση περιόδων",
    ],
    status: "included",
  },
  {
    ...
    icon: Repeat,
    name: "Επαναλαμβανόμενα παραστατικά",
    tagline: "Ρύθμισε μία φορά — εκδίδονται αυτόματα.",
    price: "Δωρεάν",
    perks: [
      "Μηνιαίες / ετήσιες σειρές",
      "Αυτόματη έκδοση + αποστολή email",
      "Πλήρη έλεγχο πριν την ενεργοποίηση",
    ],
    status: "included",
  },
  {
