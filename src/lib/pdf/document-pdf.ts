...
const DOC_TYPE_LABEL: Record<string, string> = {
  ...
  simplified_invoice: "ΑΠΛΟΠΟΙΗΜΕΝΟ ΤΙΜΟΛΟΓΙΟ",
  eu_sale_invoice: "ΤΙΜΟΛΟΓΙΟ ΠΩΛΗΣΗΣ (ΕΝΔΟΚΟΙΝΟΤΙΚΟ)",
  third_country_sale_invoice: "ΤΙΜΟΛΟΓΙΟ ΠΩΛΗΣΗΣ (ΤΡΙΤΩΝ ΧΩΡΩΝ)",
  eu_service_invoice: "ΤΙΜΟΛΟΓΙΟ ΠΑΡΟΧΗΣ (ΕΝΔΟΚΟΙΝΟΤΙΚΟ)",
  third_country_service_invoice: "ΤΙΜΟΛΟΓΙΟ ΠΑΡΟΧΗΣ (ΤΡΙΤΩΝ ΧΩΡΩΝ)",
  credit_note: "ΠΙΣΤΩΤΙΚΟ (ΜΗ ΣΥΣΧΕΤΙΖΟΜΕΝΟ)",
  credit_note_correlated: "ΠΙΣΤΩΤΙΚΟ (ΣΥΣΧΕΤΙΖΟΜΕΝΟ)",
  delivery_note: "ΔΕΛΤΙΟ ΑΠΟΣΤΟΛΗΣ",
  stay_tax_receipt: "ΑΠΟΔΕΙΞΗ ΦΟΡΟΥ ΔΙΑΜΟΝΗΣ",
  third_party_sale_invoice: "ΤΙΜΟΛΟΓΙΟ ΓΙΑ Λ/ΣΜΟ ΤΡΙΤΩΝ",
  third_party_sale_clearing: "ΕΚΚΑΘΑΡΙΣΗ ΠΩΛΗΣΕΩΝ ΤΡΙΤΩΝ",
  complementary_invoice: "ΣΥΜΠΛΗΡΩΜΑΤΙΚΟ ΤΙΜΟΛΟΓΙΟ",
  complementary_service_invoice: "ΣΥΜΠΛΗΡΩΜΑΤΙΚΟ ΠΑΡΟΧΗΣ",
  purchase_title: "ΤΙΤΛΟΣ ΚΤΗΣΗΣ",
  purchase_title_refused: "ΤΙΤΛΟΣ ΚΤΗΣΗΣ (ΑΡΝΗΣΗ)",
  self_delivery: "ΣΤΟΙΧΕΙΑ ΑΥΤΟΠΑΡΑΔΟΣΗΣ",
  self_use: "ΣΤΟΙΧΕΙΑ ΙΔΙΟΧΡΗΣΙΜΟΠΟΙΗΣΗΣ",
  contract_income: "ΣΥΜΒΟΛΑΙΟ — ΕΣΟΔΟ",
