...
const DEFAULT_SERIES: Record<DocumentType, string> = {
  ...
  delivery_note: "D",
  stay_tax_receipt: "ST",
  third_party_sale_invoice: "AT",
  third_party_sale_clearing: "AK",
  complementary_invoice: "AS",
  complementary_service_invoice: "PS",
  purchase_title: "TK",
  purchase_title_refused: "TR",
  self_delivery: "SD",
  self_use: "SU",
  contract_income: "CN",
  rental_income: "RN",
  retail_refund_receipt: "RF",
  pos_income_receipt: "PI",
  pos_payment_receipt: "PP",
  retail_credit_note: "RC",
  third_party_retail_receipt: "RT",
  delivery_note_correlated: "DC",
  quantitative_receipt: "QR",
  income_settlement_accounting: "IA",
  income_settlement_tax: "IT",
  expense_settlement_accounting: "EA",
  expense_settlement_tax: "ET",
  payroll_entry: "PE",
  depreciation: "DP",
  proforma: "PF",
  quote: "Q",
...
const DEFAULT_LABEL: Record<DocumentType, string> = {
  ...
  complementary_service_invoice: "Συμπληρωματικά παροχής",
  purchase_title: "Τίτλοι κτήσης",
  purchase_title_refused: "Τίτλοι κτήσης (άρνηση)",
  self_delivery: "Στοιχεία αυτοπαράδοσης",
  self_use: "Στοιχεία ιδιοχρησιμοποίησης",
  contract_income: "Συμβόλαια — έσοδα",
  rental_income: "Ενοίκια — έσοδα",
  retail_refund_receipt: "Αποδείξεις επιστροφής",
  pos_income_receipt: "Αποδείξεις Είσπραξης POS",
  pos_payment_receipt: "Αποδείξεις Επιστροφής POS",
  retail_credit_note: "Πιστωτικά λιανικής",
  third_party_retail_receipt: "Λιανική για λ/σμό τρίτων",
  delivery_note_correlated: "Δελτία αποστολής (συσχ.)",
  quantitative_receipt: "Δελτία ποσοτικής παραλαβής",
  income_settlement_accounting: "Τακτ. εσόδων (λογιστική)",
  income_settlement_tax: "Τακτ. εσόδων (φορολογική)",
  expense_settlement_accounting: "Τακτ. εξόδων (λογιστική)",
  expense_settlement_tax: "Τακτ. εξόδων (φορολογική)",
  payroll_entry: "Ενσωμάτωση μισθοδοσίας",
...
const WRAPP_LATIN_NAME: Record<DocumentType, string> = {
  ...
  third_party_sale_invoice: "Polisi Triton",
  third_party_sale_clearing: "Ekkatharisi Triton",
  complementary_invoice: "Sympliromatiko Timologio",
  complementary_service_invoice: "Sympliromatiko Parochis",
  purchase_title: "Titlos Ktisis",
  purchase_title_refused: "Titlos Ktisis Arnisi",
  self_delivery: "Autoparadosi",
  self_use: "Idiochrisimopoiisi",
  contract_income: "Symvolaio Esodo",
  rental_income: "Enoikio Esodo",
  retail_refund_receipt: "Apodeixi Epistrofis",
  pos_income_receipt: "Apodeixi POS Eispraxis",
  pos_payment_receipt: "Apodeixi POS Epistrofis",
  retail_credit_note: "Pistotiko Lianikis",
  third_party_retail_receipt: "Lianiki Triton",
  delivery_note_correlated: "Deltia Apostolis Correlated",
  quantitative_receipt: "Deltio Posotikis Paralavis",
  income_settlement_accounting: "Taktopoiisi Esodon Logistiki",
  income_settlement_tax: "Taktopoiisi Esodon Forologiki",
  expense_settlement_accounting: "Taktopoiisi Exodon Logistiki",
  expense_settlement_tax: "Taktopoiisi Exodon Forologiki",
  payroll_entry: "Ensomatosi Misthodosias",
  depreciation: "Aposveseis",
